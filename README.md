...
4. [Basic Dialog](#basic-dialog)
5. [Dismissing Dialogs](#dismissing-dialogs)
6. [Displaying an Icon](#displaying-an-icon)
7. [Stacked Action Buttons](#stacked-action-buttons)
    1. [Stacking Behavior](#stacking-behavior)
8. [Neutral Action Button](#neutral-action-button)
9. [Callbacks](#callbacks)
10. [CheckBox Prompts](#checkbox-prompts)
11. [List Dialogs](#list-dialogs)
12. [Single Choice List Dialogs](#single-choice-list-dialogs)
    1. [Coloring Radio Buttons](#coloring-radio-buttons)
13. [Multi Choice List Dialogs](#multi-choice-list-dialogs)
    1. [Coloring Check Boxes](#coloring-check-boxes)
14. [Assigning IDs to List Item Views](#assigning-ids-to-list-item-views)
15. [Custom List Dialogs](#custom-list-dialogs)
16. [Custom Views](#custom-views)
    1. [Later Access](#later-access)
17. [Typefaces](#typefaces)
18. [Getting and Setting Action Buttons](#getting-and-setting-action-buttons)
19. [Theming](#theming)
    1. [Basics](#basics)
    2. [Colors](#colors)
    3. [Selectors](#selectors)
    4. [Gravity](#gravity)
    5. [Material Palette](#material-palette)
20. [Global Theming](#global-theming)
21. [Show, Cancel, and Dismiss Callbacks](#show-cancel-and-dismiss-callbacks)
22. [Input Dialogs](#input-dialogs)
    1. [Coloring the EditText](#coloring-the-edittext)
    2. [Limiting Input Length](#limiting-input-length)
    3. [Custom Invalidation](#custom-invalidation)
23. [Progress Dialogs](#progress-dialogs)
    1. [Proguard](#proguard)
    2. [Indeterminate Progress Dialogs](#indeterminate-progress-dialogs)
    3. [Determinate (Seek Bar) Progress Dialogs](#determinate-seek-bar-progress-dialogs)
    4. [Make an Indeterminate Dialog Horizontal](#make-an-indeterminate-dialog-horizontal)
    5. [Coloring the Progress Bar](#coloring-the-progress-bar)
    6. [Custom Number and Progress Formats](#custom-number-and-progress-formats)
24. [Tint Helper](#tint-helper)
25. [Misc](#misc)

## Table of Contents (Commons)

1. [Color Chooser Dialogs](#color-chooser-dialogs)
    1. [Finding Visible Dialogs](#finding-visible-dialogs)
    2. [User Color Input](#user-color-input)
2. [File Selector Dialogs](#file-selector-dialogs)
3. [Folder Selector Dialogs](#folder-selector-dialogs)
4. [Preference Dialogs](#preference-dialogs)
5. [Simple List Dialogs](#simple-list-dialogs)
